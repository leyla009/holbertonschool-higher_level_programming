#!/usr/bin/python3
"""Module that defines a Rectangle class with a class method."""


class Rectangle:
    """Defines a rectangle with tracking, comparison, and factory methods.
    ...
    def square(cls, size=0):
        ...
        Args:
            cls (type): The class itself (Rectangle).
            size (int): The side length for the new square.

        Returns:
            Rectangle: A new instance where width and height equal size.
        """
